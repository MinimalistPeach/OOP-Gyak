...
public class Book extends Product{
	...
	public String toString() {
		String datas= "Author:"+author+" title:"+title+" YOR:"+yearOfPublication+" price:"+getGrossPrice()+" pages:"+pages+" style:"+style;
		return datas;
	}
	...
	public static void discountBooks(Book[] books, String style) {
		for(int i=0; i<books.length;i++) {
			if(books[i].getStyle() == style) {
				books[i].setPrice(books[i].getGrossPrice()-((books[i].getGrossPrice()/100)*10));
			}
		}
	}
